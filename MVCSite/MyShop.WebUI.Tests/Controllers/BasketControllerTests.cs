...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "somexyz@gmail.com", Zipcode = "0612" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("somexyz@gmail.com", "Forms"), null);
